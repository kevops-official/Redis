...
REDIS_PORT="36379" # Puerto por el que se expondra Redis
REDIS_CONTAINER="redis.sentinel2" # Nombre del Contenedor
REDIS_IP="10.128.0.9" # Ip del servidor donde sera desplegada esta instancia de Redis y por el que las otras instancias pueden llegar a el
REDIS_PASSWORD="sentinel2kevopspwd" # Password de esta instancia de Redis
